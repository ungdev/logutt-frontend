    ...
    <v-row>
      <v-col cols="12" sm="4">
        <v-sheet min-height="20vh" rounded="lg">
          <!-- SUB CARD START -->
          <v-text-field v-model="search" label="Rechercher" filled rounded style="padding: 10px;"></v-text-field>
      ...
      <v-card>
          ...
          <v-container>
            <v-row>
              <v-col cols="12" sm="6" md="6">
                <v-text-field v-model="name" label="Nom de la salle*" required clearable></v-text-field>
              </v-col>
              <v-col cols="12" sm="6" md="6">
                <v-text-field v-model="room" label="Numéro de la salle*" hint="Exemple : N002" persistent-hint required clearable></v-text-field>
              </v-col>
            </v-row>
          </v-container>
        ...
        <v-card-actions>
          ...
          <v-btn color="blue darken-1" text @click="newSalle">
            Ajouter
          </v-btn>
        </v-card-actions>
      </v-card>
            ...
            >
              ...
              >
                ...
                <v-row class="row">
                  ...
                  <v-list-item-subtitle v-text="salle.room"></v-list-item-subtitle>
                </v-list-item-content>
                  </v-col>
